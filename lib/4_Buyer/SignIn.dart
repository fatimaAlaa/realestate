...
class _SignInBuyerState extends State<SignInBuyer> {
  ...
  Future BuyerCheckData() async {
    String Url = "https://realestatecontract.000webhostapp.com/CheckBuyer.php";
  ...
  Future RSInfo() async {
    String Url = "https://realestatecontract.000webhostapp.com/GetRSBuyer.php";
    var res = await http.post(Uri.parse(Url), headers: {
      "Accept": "application/json"
    }, body: {
      "RealestateNumber": RealestateID.text,
